...
#explore how many categories are in each variable#
unique(steam_games$developer)
unique(steam_games$minimum_requirements)
unique(steam_games$genre)
...
```{r}
worsrs<-cancer_sample%>%select(radius_worst:fractal_dimension_worst)
```
